...
*/
--MAKING THE STORE PROCEDURE FOR BRONZE LAYER
...
BEGIN
	...
	BEGIN TRY
		...
		PRINT'---------------------------------------------------';
		-- THIS IS CALLED AS THE FULL LOAD :first delete the existing data in the table then insert it from the scratch
			--this 3 data coming from the erp source system
		...
		SET   @start_time=GETDATE();
		--=============================================================================================
				--this 3 data coming from the crm source system
		PRINT'---------------------------------------------------';
